...
function FpLegendre(order) {
  const legendreConst = (order - _1n2) / _2n;
...
function twistedEdwards(curveDef) {
  ...
  const MASK = _2n6 << BigInt(nByteLength * 8) - _1n8;
...
`);
  ...
  async syncTime(canisterId) {
    await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
    const CanisterStatus = await import("./canisterStatus-W2Y6UHLI.js");
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-4F5Z4FX7.js.map
