...
import type { Category as _Category, TransactionId as _TransactionId, Time as _Time, Transaction as _Transaction, PaymentMethod as _PaymentMethod } from "declarations/backend/backend.did.d.ts";
